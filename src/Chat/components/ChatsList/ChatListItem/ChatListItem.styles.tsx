...
export const ChatListItemContainer = styled.TouchableOpacity`${({ theme }) => `
    width: 100%;
    height: 80px;
    display: flex;
    padding: 10px;
...
export const ChatListItemDescriptionContainer = styled.View`
    height: 100%;
    display: flex;
...
interface ChatListItemNewMessagesBadgeProps extends ViewProps { 
    newMessages?: number;
}

export const ChatListItemNewMessagesBadge = styled.View
